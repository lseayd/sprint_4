...
public class OrderTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"Тест", "Тестов", "Дмитровское шоссе 13", "Дмитровская", "89999999999", "10.04.2025", "комент"},
                {"Тест2", "Тестов2", "Дмитровское шоссе 13", "Дмитровская", "89999999999", "10.04.2025", "комент"}
        });
    }
